...
- **F7 — parallel-partner separation** (flow metric, Tier 2, ADR-41).
...
- **W1 — wire against a placement-independent floor** (routing/placement
  metric, Tier 2, ADR-41). The wire-**detour** ratchet
...
- **C1 — series-chain compactness** (readability metric, **Tier 2,
  zero-slack ratchet since 2026-09-06**, ADR-28 + ADR-41). The same
  ...
  **Budget literals since 2026-09-06** (ADR-41):
  ...
  `compensated_divider` — and the other nineteen record 0. ADR-41
