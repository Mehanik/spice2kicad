...
const BASELINE: &[(&str, &str, &str, f64, f64, f64, &str)] = &[
    ...
    ("common_emitter", "CE", "Device:C", 67.31, 48.26, 0.0, ""),
    ("common_emitter", "CIN", "Device:C", 33.02, 50.8, 270.0, ""),
    (
        "common_emitter",
        "COUT",
        "Device:C",
    ...
    ("common_emitter", "RC", "Device:R_US", 33.02, 35.56, 0.0, ""),
    (
        "common_emitter",
        "RE",
        "Device:R_US",
    ...
    ("diff_pair", "#PWR1", "power:VCC", 25.4, 29.21, 0.0, ""),
    ("diff_pair", "#PWR2", "power:VCC", 35.56, 29.21, 0.0, ""),
    ("diff_pair", "#PWR3", "power:VEE", 48.26, 60.96, 0.0, ""),
    ("diff_pair", "Q1", "Device:Q_NPN_BCE", 40.64, 46.99, 0.0, ""),
    (
        "diff_pair",
        "Q2",
        "Device:Q_NPN_BCE",
    ...
    ("diff_pair", "RC1", "Device:R_US", 25.4, 33.02, 0.0, ""),
    ("diff_pair", "RC2", "Device:R_US", 35.56, 33.02, 0.0, "y"),
    ("diff_pair", "RTAIL", "Device:R_US", 48.26, 57.15, 0.0, ""),
    (
        "multivibrator",
        "#FLG1",
        "power:PWR_FLAG",
    ...
    ("rc_lowpass", "#PWR1", "power:GND", 35.56, 34.29, 0.0, ""),
    ("rc_lowpass", "C1", "Device:C", 35.56, 30.48, 0.0, ""),
