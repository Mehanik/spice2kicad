...
const BASELINE: &[(&str, &str, &str, f64, f64, f64, &str)] = &[
    ...
    ("common_emitter", "CE", "Device:C", 72.39, 53.34, 0.0, ""),
    ("common_emitter", "CIN", "Device:C", 29.21, 48.26, 90.0, ""),
    ("common_emitter", "COUT", "Device:C", 80.01, 43.18, 0.0, ""),
    (
        "common_emitter",
        "Q1",
        "Device:Q_NPN_BCE",
    ...
    ("common_emitter", "R2", "Device:R_US", 49.53, 41.91, 0.0, ""),
    ("common_emitter", "RC", "Device:R_US", 46.99, 35.56, 0.0, ""),
    ("common_emitter", "RE", "Device:R_US", 59.69, 58.42, 0.0, ""),
    (
        "diff_pair",
        "#FLG1",
        "power:PWR_FLAG",
    ...
    ("rc_lowpass", "#PWR1", "power:GND", 31.75, 34.29, 0.0, ""),
    ("rc_lowpass", "#PWR2", "power:GND", 44.45, 36.83, 0.0, ""),
    ("rc_lowpass", "C1", "Device:C", 31.75, 30.48, 0.0, ""),
    ("rc_lowpass", "R1", "Device:R_US", 27.94, 30.48, 180.0, ""),
    (
        "rc_lowpass_ports",
        "#FLG1",
        "power:PWR_FLAG",
