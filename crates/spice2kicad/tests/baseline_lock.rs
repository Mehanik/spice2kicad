...
const BASELINE: &[(&str, &str, &str, f64, f64, f64, &str)] = &[
    ...
    ("common_emitter", "#PWR1", "power:GND", 50.8, 45.72, 0.0, ""),
    (
        "common_emitter",
        "#PWR2",
        "power:GND",
    ...
    ("common_emitter", "CE", "Device:C", 73.66, 53.34, 0.0, ""),
    ("common_emitter", "CIN", "Device:C", 30.48, 48.26, 0.0, ""),
    ("common_emitter", "COUT", "Device:C", 81.28, 43.18, 0.0, ""),
    (
        "common_emitter",
        "Q1",
        "Device:Q_NPN_BCE",
    ...
    ("common_emitter", "R2", "Device:R_US", 50.8, 41.91, 0.0, ""),
    ("common_emitter", "RC", "Device:R_US", 48.26, 35.56, 0.0, ""),
    ("common_emitter", "RE", "Device:R_US", 60.96, 58.42, 0.0, ""),
    (
        "diff_pair",
        "#FLG1",
        "power:PWR_FLAG",
    ...
    ("diff_pair", "RC1", "Device:R_US", 27.94, 33.02, 0.0, ""),
    ("diff_pair", "RC2", "Device:R_US", 38.1, 33.02, 0.0, "y"),
    ("diff_pair", "RTAIL", "Device:R_US", 50.8, 57.15, 0.0, ""),
    (
        "multivibrator",
        "#FLG1",
        "power:PWR_FLAG",
    ...
    ("multivibrator", "#PWR1", "power:GND", 48.26, 71.12, 0.0, ""),
    ("multivibrator", "#PWR2", "power:GND", 58.42, 71.12, 0.0, ""),
    ("multivibrator", "#PWR3", "power:VCC", 30.48, 29.21, 0.0, ""),
    ("multivibrator", "#PWR4", "power:VCC", 76.2, 29.21, 0.0, ""),
    ("multivibrator", "#PWR5", "power:VCC", 29.21, 41.91, 0.0, ""),
    ("multivibrator", "#PWR6", "power:VCC", 77.47, 41.91, 0.0, ""),
    ("multivibrator", "#PWR7", "power:GND", 88.9, 73.66, 0.0, ""),
    ("multivibrator", "#PWR8", "power:VCC", 88.9, 86.36, 0.0, ""),
    ("multivibrator", "C1", "Device:C", 45.72, 49.53, 0.0, ""),
    ("multivibrator", "C2", "Device:C", 60.96, 49.53, 0.0, "y"),
    (
        "multivibrator",
        "Q1",
        "Device:Q_NPN_BCE",
    ...
    ("multivibrator", "RB1", "Device:R_US", 29.21, 45.72, 0.0, ""),
    (
        "multivibrator",
        "RB2",
        "Device:R_US",
    ...
    ("multivibrator", "RC1", "Device:R_US", 30.48, 33.02, 0.0, ""),
    ("multivibrator", "RC2", "Device:R_US", 76.2, 33.02, 0.0, "y"),
    (
    ...
    ("port_shapes", "#PWR1", "power:GND", 74.93, 48.26, 0.0, ""),
    ("port_shapes", "#PWR2", "power:GND", 86.36, 50.8, 0.0, ""),
    ("port_shapes", "R1", "Device:R_US", 27.94, 29.21, 0.0, ""),
    ("port_shapes", "R2", "Device:R_US", 27.94, 38.1, 0.0, ""),
    ("port_shapes", "R3", "Device:R_US", 74.93, 35.56, 0.0, ""),
    ("port_shapes", "R4", "Device:R_US", 74.93, 44.45, 0.0, ""),
    (
        "rc_lowpass",
        "#FLG1",
        "power:PWR_FLAG",
    ...
    ("rc_lowpass", "#PWR1", "power:GND", 34.29, 34.29, 0.0, ""),
    ("rc_lowpass", "#PWR2", "power:GND", 46.99, 36.83, 0.0, ""),
    ("rc_lowpass", "C1", "Device:C", 34.29, 30.48, 0.0, ""),
    ("rc_lowpass", "R1", "Device:R_US", 30.48, 30.48, 0.0, ""),
    (
        "rc_lowpass_ports",
        "#FLG1",
        "power:PWR_FLAG",
    ...
    ("rc_lowpass_ports", "C1", "Device:C", 33.02, 30.48, 0.0, ""),
    (
        "rc_lowpass_ports",
        "R1",
        "Device:R_US",
