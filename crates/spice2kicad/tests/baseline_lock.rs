...
const BASELINE: &[(&str, &str, &str, f64, f64, f64, &str)] = &[
    ...
    ("common_emitter", "#PWR3", "power:GND", 63.5, 48.26, 0.0, ""),
    (
        "common_emitter",
        "#PWR4",
        "power:VCC",
    ...
    ("common_emitter", "CE", "Device:C", 59.69, 48.26, 90.0, ""),
    ("common_emitter", "CIN", "Device:C", 29.21, 44.45, 90.0, ""),
    ("common_emitter", "COUT", "Device:C", 74.93, 36.83, 0.0, ""),
    (
        "common_emitter",
        "Q1",
        "Device:Q_NPN_BCE",
    ...
    ("common_emitter", "R2", "Device:R_US", 50.8, 35.56, 90.0, ""),
    ("common_emitter", "RC", "Device:R_US", 26.67, 30.48, 0.0, ""),
    ("common_emitter", "RE", "Device:R_US", 49.53, 52.07, 0.0, ""),
    ("diff_pair", "#PWR1", "power:VCC", 33.02, 26.67, 0.0, ""),
    ("diff_pair", "#PWR2", "power:VCC", 41.91, 26.67, 0.0, ""),
    ("diff_pair", "#PWR3", "power:GND", 25.4, 35.56, 0.0, ""),
    ("diff_pair", "Q1", "Device:Q_NPN_BCE", 48.26, 44.45, 0.0, ""),
    (
        "diff_pair",
        "Q2",
        "Device:Q_NPN_BCE",
    ...
    ("diff_pair", "RC1", "Device:R_US", 33.02, 30.48, 0.0, ""),
    ("diff_pair", "RC2", "Device:R_US", 41.91, 30.48, 0.0, "y"),
    ("diff_pair", "RTAIL", "Device:R_US", 29.21, 35.56, 270.0, ""),
    ("multivibrator", "#PWR1", "power:GND", 44.45, 68.58, 0.0, ""),
    ("multivibrator", "#PWR2", "power:GND", 48.26, 68.58, 0.0, ""),
    ("multivibrator", "#PWR3", "power:VCC", 26.67, 26.67, 0.0, ""),
    ("multivibrator", "#PWR4", "power:VCC", 66.04, 26.67, 0.0, ""),
    ("multivibrator", "#PWR5", "power:VCC", 25.4, 39.37, 0.0, ""),
    ("multivibrator", "#PWR6", "power:VCC", 67.31, 39.37, 0.0, ""),
    ("multivibrator", "C1", "Device:C", 41.91, 46.99, 0.0, ""),
    ("multivibrator", "C2", "Device:C", 50.8, 46.99, 0.0, "y"),
    (
        "multivibrator",
        "Q1",
        "Device:Q_NPN_BCE",
    ...
    ("multivibrator", "RB1", "Device:R_US", 25.4, 43.18, 0.0, ""),
    (
        "multivibrator",
        "RB2",
        "Device:R_US",
    ...
    ("multivibrator", "RC1", "Device:R_US", 26.67, 30.48, 0.0, ""),
    (
        "multivibrator",
        "RC2",
        "Device:R_US",
