...
const BASELINE: &[(&str, &str, &str, f64, f64, f64, &str)] = &[
    ...
    ("common_emitter", "#PWR2", "power:GND", 50.8, 55.88, 0.0, ""),
    (
        "common_emitter",
        "#PWR3",
        "power:GND",
    ...
    ("common_emitter", "CE", "Device:C", 60.96, 48.26, 0.0, ""),
    ("common_emitter", "CIN", "Device:C", 30.48, 44.45, 90.0, ""),
    ("common_emitter", "COUT", "Device:C", 76.2, 36.83, 0.0, ""),
    (
        "common_emitter",
        "Q1",
        "Device:Q_NPN_BCE",
    ...
    ("common_emitter", "RE", "Device:R_US", 50.8, 52.07, 0.0, ""),
    ...
    ("multivibrator", "#PWR4", "power:VCC", 69.85, 26.67, 0.0, ""),
    ("multivibrator", "#PWR5", "power:VCC", 25.4, 39.37, 0.0, ""),
    ("multivibrator", "#PWR6", "power:VCC", 71.12, 39.37, 0.0, ""),
    ("multivibrator", "C1", "Device:C", 41.91, 46.99, 0.0, ""),
    ("multivibrator", "C2", "Device:C", 54.61, 46.99, 0.0, "y"),
    (
        "multivibrator",
        "Q1",
        "Device:Q_NPN_BCE",
