...
const BASELINE: &[(&str, &str, &str, f64, f64, f64, &str)] = &[
    ...
    ("cascode_amp", "#PWR1", "power:GND", 39.37, 76.2, 0.0, ""),
    ("cascode_amp", "#PWR2", "power:GND", 46.99, 87.63, 0.0, ""),
    ("cascode_amp", "#PWR3", "power:GND", 53.34, 87.63, 0.0, ""),
    ("cascode_amp", "#PWR4", "power:GND", 59.69, 87.63, 0.0, ""),
    ("cascode_amp", "#PWR5", "power:+12V", 46.99, 31.75, 0.0, ""),
    ("cascode_amp", "#PWR6", "power:+12V", 63.5, 31.75, 0.0, ""),
    ("cascode_amp", "#PWR7", "power:GND", 85.09, 90.17, 0.0, ""),
    ("cascode_amp", "#PWR8", "power:+12V", 85.09, 102.87, 0.0, ""),
    ("cascode_amp", "CB2", "Device:C", 46.99, 83.82, 0.0, "y"),
    ("cascode_amp", "CE", "Device:C", 59.69, 83.82, 0.0, ""),
    ("cascode_amp", "CIN", "Device:C", 35.56, 62.23, 90.0, ""),
    ("cascode_amp", "COUT", "Device:C", 72.39, 58.42, 0.0, ""),
    (
        "cascode_amp",
        "Q1",
        "Device:Q_NPN_BCE",
    ...
    ("cascode_amp", "RB1", "Device:R_US", 46.99, 35.56, 0.0, "y"),
    ("cascode_amp", "RB2", "Device:R_US", 39.37, 54.61, 270.0, ""),
    ("cascode_amp", "RB3", "Device:R_US", 39.37, 72.39, 0.0, ""),
    ("cascode_amp", "RC", "Device:R_US", 63.5, 35.56, 0.0, ""),
    ("cascode_amp", "RE", "Device:R_US", 53.34, 83.82, 0.0, ""),
    (
        "common_emitter",
        "#FLG1",
        "power:PWR_FLAG",
    ...
    ("common_emitter", "#PWR6", "power:GND", 82.55, 76.2, 0.0, ""),
    (
        "common_emitter",
        "#PWR7",
        "power:+12V",
    ...
    ("common_emitter", "CE", "Device:C", 59.69, 69.85, 0.0, ""),
    ("common_emitter", "CIN", "Device:C", 35.56, 53.34, 90.0, ""),
    ("common_emitter", "COUT", "Device:C", 69.85, 48.26, 0.0, ""),
    (
        "common_emitter",
        "Q1",
        "Device:Q_NPN_BCE",
    ...
    ("common_emitter", "RE", "Device:R_US", 53.34, 69.85, 0.0, ""),
    (
        "diff_pair",
        "#FLG1",
        "power:PWR_FLAG",
    ...
    ("lc_ladder_lpf", "#PWR1", "power:GND", 35.56, 52.07, 0.0, ""),
    ("lc_ladder_lpf", "#PWR2", "power:GND", 39.37, 52.07, 0.0, ""),
    ("lc_ladder_lpf", "#PWR3", "power:GND", 68.58, 52.07, 0.0, ""),
    ("lc_ladder_lpf", "#PWR4", "power:GND", 102.87, 50.8, 0.0, ""),
    (
        "lc_ladder_lpf",
        "#PWR5",
        "power:GND",
    ...
    ("lc_ladder_lpf", "C1", "Device:C", 39.37, 48.26, 0.0, ""),
    ("lc_ladder_lpf", "C2", "Device:C", 68.58, 48.26, 0.0, "y"),
    ("lc_ladder_lpf", "C3", "Device:C", 102.87, 46.99, 0.0, ""),
    ("lc_ladder_lpf", "C4", "Device:C", 109.22, 48.26, 0.0, ""),
    ("lc_ladder_lpf", "L1", "Device:L", 57.15, 36.83, 90.0, ""),
    ("lc_ladder_lpf", "L2", "Device:L", 72.39, 39.37, 0.0, ""),
    ("lc_ladder_lpf", "L3", "Device:L", 110.49, 39.37, 270.0, ""),
    (
        "lc_ladder_lpf",
        "RL",
        "Device:R_US",
    ...
    ("lc_ladder_lpf", "RS", "Device:R_US", 38.1, 35.56, 180.0, ""),
    (
        "lc_ladder_lpf",
        "VIN",
    ...
    ("named_rails", "#PWR4", "power:GND", 55.88, 58.42, 0.0, ""),
    ("named_rails", "#PWR5", "power:VEE", 55.88, 71.12, 180.0, ""),
    ("named_rails", "#PWR6", "power:+5V", 55.88, 83.82, 0.0, ""),
    ...
    ("port_shapes", "#PWR1", "power:GND", 67.31, 54.61, 0.0, ""),
    ("port_shapes", "#PWR2", "power:GND", 78.74, 57.15, 0.0, ""),
    ("port_shapes", "R1", "Device:R_US", 35.56, 35.56, 0.0, ""),
    ("port_shapes", "R2", "Device:R_US", 35.56, 44.45, 0.0, ""),
    ("port_shapes", "R3", "Device:R_US", 67.31, 41.91, 0.0, ""),
    ("port_shapes", "R4", "Device:R_US", 67.31, 50.8, 0.0, ""),
    (
        "rc_lowpass",
        "#FLG1",
        "power:PWR_FLAG",
    ...
    ("rc_phase_shift", "#PWR4", "power:GND", 88.9, 81.28, 0.0, ""),
    (
        "rc_phase_shift",
        "#PWR5",
        "power:GND",
    ...
    ("rc_phase_shift", "C1", "Device:C", 39.37, 68.58, 0.0, ""),
    ("rc_phase_shift", "C2", "Device:C", 53.34, 62.23, 0.0, ""),
    ("rc_phase_shift", "C3", "Device:C", 68.58, 62.23, 0.0, ""),
    ("rc_phase_shift", "CE", "Device:C", 99.06, 77.47, 0.0, "y"),
    ("rc_phase_shift", "CIN", "Device:C", 80.01, 53.34, 90.0, ""),
    (
        "rc_phase_shift",
        "COUT",
        "Device:C",
    ...
    ("rc_phase_shift", "RB", "Device:R_US", 83.82, 41.91, 0.0, ""),
    ("rc_phase_shift", "RC", "Device:R_US", 95.25, 35.56, 0.0, ""),
    ("rc_phase_shift", "RE", "Device:R_US", 88.9, 77.47, 0.0, ""),
    (
        "sallen_key_driven",
        "#FLG1",
        "power:PWR_FLAG",
    ...
    ("sallen_key_lpf", "#PWR2", "power:GND", 83.82, 63.5, 0.0, ""),
    (
        "sallen_key_lpf",
        "#PWR3",
        "power:VCC",
    ...
    ("sallen_key_lpf", "C1", "Device:C", 76.2, 46.99, 270.0, ""),
    ("sallen_key_lpf", "C2", "Device:C", 52.07, 53.34, 0.0, ""),
    (
        "sallen_key_lpf",
        "R1",
        "Device:R_US",
    ...
    ("sallen_key_lpf", "RA", "Device:R_US", 80.01, 50.8, 90.0, ""),
    ("sallen_key_lpf", "RB", "Device:R_US", 83.82, 59.69, 0.0, ""),
    (
        "sallen_key_lpf",
        "X1",
        "Amplifier_Operational:OPAMP",
    ...
    ("shunt_feedback_amp", "CE", "Device:C", 57.15, 63.5, 0.0, ""),
    (
        "shunt_feedback_amp",
        "CIN",
        "Device:C",
    ...
    ("two_stage_amp", "#PWR1", "power:GND", 41.91, 97.79, 0.0, ""),
    (
        "two_stage_amp",
        "#PWR10",
        "power:+12V",
    ...
    ("two_stage_amp", "#PWR2", "power:GND", 53.34, 99.06, 0.0, ""),
    (
        "two_stage_amp",
        "#PWR3",
        "power:GND",
    ...
    ("two_stage_amp", "#PWR5", "power:GND", 87.63, 97.79, 0.0, ""),
    (
        "two_stage_amp",
        "#PWR6",
        "power:GND",
    ...
    ("two_stage_amp", "CC", "Device:C", 68.58, 58.42, 90.0, ""),
    ("two_stage_amp", "CE1", "Device:C", 58.42, 96.52, 0.0, ""),
    ("two_stage_amp", "CE2", "Device:C", 95.25, 96.52, 0.0, "y"),
    ("two_stage_amp", "CIN", "Device:C", 41.91, 69.85, 0.0, ""),
    ("two_stage_amp", "COUT", "Device:C", 101.6, 66.04, 180.0, ""),
    (
        "two_stage_amp",
        "Q1",
        "Device:Q_NPN_BCE",
    ...
    ("two_stage_amp", "RB2", "Device:R_US", 41.91, 93.98, 0.0, ""),
    ("two_stage_amp", "RB3", "Device:R_US", 72.39, 35.56, 0.0, ""),
    ("two_stage_amp", "RB4", "Device:R_US", 74.93, 96.52, 0.0, ""),
    ("two_stage_amp", "RC1", "Device:R_US", 58.42, 35.56, 0.0, ""),
    ("two_stage_amp", "RC2", "Device:R_US", 88.9, 35.56, 0.0, ""),
    (
        "two_stage_amp",
        "RE1",
        "Device:R_US",
    ...
    ("two_stage_amp", "RE2", "Device:R_US", 87.63, 93.98, 0.0, ""),
    (
        "wien_bridge_osc",
        "#FLG1",
        "power:PWR_FLAG",
