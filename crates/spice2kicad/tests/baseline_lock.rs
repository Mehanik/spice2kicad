...
const BASELINE: &[(&str, &str, &str, f64, f64, f64, &str)] = &[
    ...
    ("common_emitter", "CE", "Device:C", 69.85, 48.26, 0.0, ""),
    ("common_emitter", "CIN", "Device:C", 35.56, 50.8, 270.0, ""),
    (
        "common_emitter",
        "COUT",
        "Device:C",
    ...
    ("common_emitter", "RC", "Device:R_US", 35.56, 35.56, 0.0, ""),
    (
        "common_emitter",
        "RE",
        "Device:R_US",
    ...
    ("diff_pair", "#PWR1", "power:VCC", 36.83, 29.21, 0.0, ""),
    ("diff_pair", "#PWR2", "power:VCC", 46.99, 29.21, 0.0, ""),
    ("diff_pair", "#PWR3", "power:VEE", 33.02, 41.91, 0.0, ""),
    ("diff_pair", "Q1", "Device:Q_NPN_BCE", 52.07, 46.99, 0.0, ""),
    (
        "diff_pair",
        "Q2",
        "Device:Q_NPN_BCE",
    ...
    ("diff_pair", "RC1", "Device:R_US", 36.83, 33.02, 0.0, ""),
    ("diff_pair", "RC2", "Device:R_US", 46.99, 33.02, 0.0, "y"),
    ("diff_pair", "RTAIL", "Device:R_US", 33.02, 38.10, 0.0, "y"),
    (
        "multivibrator",
        "#FLG1",
        "power:PWR_FLAG",
    ...
    ("rc_lowpass", "R1", "Device:R_US", 25.40, 30.48, 180.0, ""),
];
