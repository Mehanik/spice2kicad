...
const BASELINE: &[(&str, &str, &str, f64, f64, f64, &str)] = &[
    ...
    ("multivibrator", "#PWR1", "power:GND", 44.45, 71.12, 0.0, ""),
    ("multivibrator", "#PWR2", "power:GND", 54.61, 71.12, 0.0, ""),
    ("multivibrator", "#PWR3", "power:VCC", 26.67, 29.21, 0.0, ""),
    ("multivibrator", "#PWR4", "power:VCC", 72.39, 29.21, 0.0, ""),
    ("multivibrator", "#PWR5", "power:VCC", 25.40, 41.91, 0.0, ""),
    ("multivibrator", "#PWR6", "power:VCC", 73.66, 41.91, 0.0, ""),
    ("multivibrator", "C1", "Device:C", 41.91, 49.53, 0.0, ""),
    ("multivibrator", "C2", "Device:C", 57.15, 49.53, 0.0, "y"),
    (
        "multivibrator",
        "Q1",
        "Device:Q_NPN_BCE",
    ...
    ("multivibrator", "RB1", "Device:R_US", 25.40, 45.72, 0.0, ""),
    (
        "multivibrator",
        "RB2",
        "Device:R_US",
    ...
    ("multivibrator", "RC1", "Device:R_US", 26.67, 33.02, 0.0, ""),
    (
        "multivibrator",
        "RC2",
        "Device:R_US",
