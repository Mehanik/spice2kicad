...
const BASELINE: &[(&str, &str, &str, f64, f64, f64, &str)] = &[
    ...
    ("cascode_amp", "#PWR1", "power:GND", 39.37, 74.93, 0.0, ""),
    ("cascode_amp", "#PWR2", "power:GND", 50.8, 83.82, 0.0, ""),
    ("cascode_amp", "#PWR3", "power:GND", 44.45, 82.55, 0.0, ""),
    ("cascode_amp", "#PWR4", "power:GND", 55.88, 83.82, 0.0, ""),
    ("cascode_amp", "#PWR5", "power:+12V", 46.99, 31.75, 0.0, ""),
    ("cascode_amp", "#PWR6", "power:+12V", 52.07, 33.02, 0.0, ""),
    ("cascode_amp", "#PWR7", "power:GND", 93.98, 86.36, 0.0, ""),
    ("cascode_amp", "#PWR8", "power:+12V", 93.98, 99.06, 0.0, ""),
    ("cascode_amp", "CB2", "Device:C", 50.8, 80.01, 0.0, "y"),
    ("cascode_amp", "CE", "Device:C", 55.88, 80.01, 0.0, ""),
    ("cascode_amp", "CIN", "Device:C", 35.56, 60.96, 90.0, ""),
    ("cascode_amp", "COUT", "Device:C", 81.28, 57.15, 0.0, ""),
    (
        "cascode_amp",
        "Q1",
        "Device:Q_NPN_BCE",
    ...
    ("cascode_amp", "RB1", "Device:R_US", 46.99, 35.56, 0.0, ""),
    ("cascode_amp", "RB2", "Device:R_US", 41.91, 60.96, 0.0, ""),
    ("cascode_amp", "RB3", "Device:R_US", 39.37, 71.12, 0.0, ""),
    ("cascode_amp", "RC", "Device:R_US", 52.07, 36.83, 0.0, ""),
    ("cascode_amp", "RE", "Device:R_US", 44.45, 78.74, 0.0, ""),
    (
        "common_emitter",
        "#FLG1",
        "power:PWR_FLAG",
    ...
    ("rc_phase_shift", "CE", "Device:C", 59.69, 87.63, 0.0, ""),
    ("rc_phase_shift", "CIN", "Device:C", 46.99, 55.88, 90.0, ""),
    ("rc_phase_shift", "COUT", "Device:C", 82.55, 45.72, 0.0, ""),
    (
        "rc_phase_shift",
        "Q1",
        "Device:Q_NPN_BCE",
    ...
    ("rc_phase_shift", "RB", "Device:R_US", 54.61, 43.18, 0.0, ""),
    ("rc_phase_shift", "RC", "Device:R_US", 52.07, 35.56, 0.0, ""),
    ("rc_phase_shift", "RE", "Device:R_US", 40.64, 87.63, 0.0, ""),
    (
        "sallen_key_driven",
        "#FLG1",
        "power:PWR_FLAG",
    ...
    ("sallen_key_lpf", "C1", "Device:C", 96.52, 46.99, 90.0, ""),
    ("sallen_key_lpf", "C2", "Device:C", 53.34, 53.34, 0.0, ""),
    (
        "sallen_key_lpf",
        "R1",
        "Device:R_US",
    ...
    ("sallen_key_lpf", "RA", "Device:R_US", 96.52, 50.8, 90.0, ""),
    (
        "sallen_key_lpf",
        "RB",
        "Device:R_US",
    ...
    ("two_stage_amp", "#PWR1", "power:GND", 35.56, 101.6, 0.0, ""),
    (
        "two_stage_amp",
        "#PWR10",
        "power:+12V",
    ...
    ("two_stage_amp", "#PWR4", "power:GND", 55.88, 99.06, 0.0, ""),
    (
        "two_stage_amp",
        "#PWR5",
        "power:GND",
    ...
    ("two_stage_amp", "#PWR6", "power:GND", 62.23, 96.52, 0.0, ""),
    (
        "two_stage_amp",
        "#PWR7",
        "power:+12V",
    ...
    ("two_stage_amp", "#PWR8", "power:+12V", 63.5, 41.91, 0.0, ""),
    (
        "two_stage_amp",
        "#PWR9",
        "power:+12V",
    ...
    ("two_stage_amp", "CC", "Device:C", 55.88, 62.23, 180.0, ""),
    ("two_stage_amp", "CE1", "Device:C", 60.96, 107.95, 0.0, ""),
    ("two_stage_amp", "CE2", "Device:C", 62.23, 92.71, 0.0, "y"),
    ("two_stage_amp", "CIN", "Device:C", 38.1, 72.39, 0.0, ""),
    ("two_stage_amp", "COUT", "Device:C", 83.82, 58.42, 90.0, ""),
    (
        "two_stage_amp",
        "Q1",
        "Device:Q_NPN_BCE",
    ...
    ("two_stage_amp", "RB1", "Device:R_US", 36.83, 39.37, 0.0, ""),
    ("two_stage_amp", "RB2", "Device:R_US", 35.56, 97.79, 0.0, ""),
    ("two_stage_amp", "RB3", "Device:R_US", 57.15, 35.56, 0.0, ""),
    (
        "two_stage_amp",
        "RB4",
        "Device:R_US",
    ...
    ("two_stage_amp", "RC1", "Device:R_US", 63.5, 45.72, 0.0, ""),
    ("two_stage_amp", "RC2", "Device:R_US", 55.88, 44.45, 0.0, ""),
    (
        "two_stage_amp",
        "RE1",
        "Device:R_US",
