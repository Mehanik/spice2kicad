...
const METRICS: &[Metric] = &[
    ...
    // F7 — parallel-partner separation (ADR-42). Tier 2 and 1.0 point per
    ...
    // Wire against a PLACEMENT-INDEPENDENT floor (ADR-42). `detour`
    ...
    // PROMOTED out of `Tier::Info` (ADR-42, 2026-09-06). It is now a
